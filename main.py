...
Button(root, text="=", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#4CAF50", command=calculate).place(x=150, y=500)
Button(root, text="DEL", width=5, height=1, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#FFA500", command=delete_last).place(x=290, y=500)
